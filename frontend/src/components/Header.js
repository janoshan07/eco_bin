        ...
        <div>
            <nav>
                ...
                <ul className={isMenuOpen ? "active" : ""}>
                    ...
                    <li><Link to="/recyclehome">Recycle Management</Link></li>
                    <li><Link to="/addschedule">Garbage Handover</Link></li>
                    <li><Link to="/Compost-Actions">Purchase Fertilizer</Link></li>
                    <li><Link to="/Garbage-Actions" state={{ userEmail }}>Waste Collection</Link></li>
